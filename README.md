...
- 고점권 초대형 언급 경보: 직전 26주 최고 종가의 90% 이상이면서 이전 52주 언급량 중앙값보다 `+10건·5배` 이상
- 당시에도 알 수 있었던 `실시간 첫 경보`와 사건 종료 후 확인하는 `언급량 정점(사후)` 분리
- 경보 후 1·2·4·8·12주 수익률과 MFE(최대 상승폭)·MAE(최대 하락폭)
- 언급 급증이 없었던 일반 고점권, 여러 경보 기준 조합과의 비교
- 관심도 백분위와 이후 수익률의 Pearson·Spearman 상관, 52주 롤링 상관, 시장 국면별 차이
- 가격 위치를 따지지 않은 넓은 언급 급증 이후 결과
- 양방향 Granger 선행성 검정과 Benjamini-Hochberg FDR 보정
- 워크포워드 OOS R²와 방향 적중률로 표본외 예측 성능 점검
